...
<p>
To configure click on Files -> Download and when it finishes click on Files -> Extract to place all files in the right place and create the database. After that you will have some doom engine games, mods and a lot of megawads. I choose then based on this thread https://www.doomworld.com/forum/topic/93734-doomworld-community-top-wads-of-all-time/. It's not the same list since I included some megawad sequences and eviternity, I had to exclude Sunder since download from dropbox wasn't work with my code.
</p>
<p>
