...
class FrmManageGames(ModalWindow):
    ...
    def btn_delete_on_press(self, _widget):
        ...
        dialog = Dialog(self.popup, _("Delete game") + " " + str(game) + "?", txt_ok=_("Yes"),
                        txt_cancel=_("No"), icon="question")
    ...
    def create_grid(self):
        ...
        self.create_box_buttons(_('Delete'), _('Close'))
        self.btnEdit = self.add_buton(_('Edit'))
        self.btnAdd = self.add_buton(_('Add'))
